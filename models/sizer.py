...
class Sizer(nn.Module):
    def __init__(self):
        ...
        self.conv_blocks = nn.Sequential(nn.Conv2d(1, 3, kernel_size=2, stride=2), 
                                         iblock(3), nn.ELU(), nn.BatchNorm2d(3),
                                         nn.Conv2d(3, 8, kernel_size=2, stride=2), 
                                         iblock(8), nn.ELU(), nn.BatchNorm2d(8),
                                         nn.Conv2d(8, 16, kernel_size=2, stride=2), 
                                         iblock(16), nn.ELU(), nn.BatchNorm2d(16),
                                         nn.Conv2d(16, 32, kernel_size=2, stride=2), 
                                         iblock(32), nn.ELU(), nn.BatchNorm2d(32),
                                         nn.Conv2d(32, 3, kernel_size=1), nn.Sigmoid(),
