...
class Segmenter(nn.Module):
    def __init__(self):
        ...
        self.downscale = nn.ModuleList([Pooling(16, 32), Pooling(32, 64)])
        ...
        self.in_cnn = nn.ModuleList([nn.Sequential(iblock(16), iblock(16)),
        ...
        self.last_cnn = nn.Sequential(nn.ReLU(), nn.BatchNorm2d(8),
                                      nn.Conv2d(8, 3, kernel_size=1), nn.Sigmoid())
