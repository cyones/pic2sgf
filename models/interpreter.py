...
class Interpreter(nn.Module):
    def __init__(self):
        ...
        self.conv_blocks = nn.Sequential(
            ...
            iblock(12), iblock(12), iblock(12),
            Pooling(12, 24), 
            iblock(24), iblock(24), iblock(24),
            Pooling(24, 48), 
            iblock(48), iblock(48), iblock(48),
            Pooling(48, 96),
            iblock(96, ksize=1), iblock(96, ksize=1), iblock(96, ksize=1),
            nn.GELU(), nn.BatchNorm2d(96),
            )
        self.displacement = nn.Sequential(
            nn.Conv2d(96, 2, kernel_size=1)
        )
